...
<head>
    <style>
        ...
        .hero h1 {
            ...
            font-weight: 900;
            margin-bottom: 20px;
            background: linear-gradient(90deg, #b30000, #530000);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            position: relative;
            letter-spacing: 2px;
        ...
        .hero h1::after {
            ...
            border-radius: 3px;
            background: linear-gradient(90deg, #b30000, #530000);
            box-shadow: 0 0 8px rgba(179, 0, 0, 0.8);
        }
        .hero p {
            font-size: 20px;
            margin-bottom: 30px;
            font-weight: 600;
            color: #ffd6d6;
            text-shadow: 1px 1px 5px rgba(179, 0, 0, 0.7);
    ...
    <div class="hero">
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                <a href="discussuion.php" class="primary">Discussion Channel</a>
